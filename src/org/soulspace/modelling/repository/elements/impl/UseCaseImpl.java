...
import org.soulspace.modelling.repository.elements.ExtensionPoint;
...
public  class UseCaseImpl extends AbstractUseCase implements UseCase {
	...
	public UseCaseImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement);
	}
	
	public UseCaseImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName) {
