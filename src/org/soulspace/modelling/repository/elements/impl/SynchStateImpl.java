...
public  class SynchStateImpl extends AbstractSynchState implements SynchState {
	...
	public SynchStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  int bound,  Element parentElement) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, bound, parentElement);
	}
	
	public SynchStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  int bound) {
