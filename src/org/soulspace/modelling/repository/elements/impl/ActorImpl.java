...
public  class ActorImpl extends AbstractActor implements Actor {
	...
	public ActorImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement,  Actor subActor,  Actor superActor) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement, subActor, superActor);
	}
	
	public ActorImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Actor subActor,  Actor superActor) {
