...
public  class DestroyActionImpl extends AbstractDestroyAction implements DestroyAction {

	private static final long serialVersionUID = 1L;

	public DestroyActionImpl() {
		super();
	}
	
	public DestroyActionImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement);
	}
	
	public DestroyActionImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName) {
