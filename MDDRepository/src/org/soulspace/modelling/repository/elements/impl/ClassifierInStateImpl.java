...
public  class ClassifierInStateImpl extends AbstractClassifierInState implements ClassifierInState {
	...
	public ClassifierInStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement,  Classifier type) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement, type);
	}
	
	public ClassifierInStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Classifier type) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, type);
	}
