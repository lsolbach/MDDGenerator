...
public  class ActionStateImpl extends AbstractActionState implements ActionState {
	...
	public ActionStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  boolean isDynamic,  Multiplicity dynamicMultiplicity,  Element parentElement,  Action entryAction,  Action exitAction,  Action doActivity) {
	...
	public ActionStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  boolean isDynamic,  Multiplicity dynamicMultiplicity) {
