...
import org.soulspace.modelling.repository.elements.Enumeration;
import org.soulspace.modelling.repository.elements.EnumerationLiteral;
...
public  class EnumerationImpl extends AbstractEnumeration implements Enumeration {
	...
	public EnumerationImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement);
	}
	
	public EnumerationImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName) {
