...
public  class EnumerationLiteralImpl extends AbstractEnumerationLiteral implements EnumerationLiteral {
	...
	public EnumerationLiteralImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement);
	}
	
	public EnumerationLiteralImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName) {
