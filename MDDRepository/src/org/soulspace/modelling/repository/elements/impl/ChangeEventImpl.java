...
public  class ChangeEventImpl extends AbstractChangeEvent implements ChangeEvent {
	...
	public ChangeEventImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  String expression,  Element parentElement) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, expression, parentElement);
	}
	
	public ChangeEventImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  String expression) {
