...
public  class SubmachineStateImpl extends AbstractSubmachineState implements SubmachineState {
	...
	public SubmachineStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  boolean isConccurent,  Element parentElement,  Action entryAction,  Action exitAction,  Action doActivity,  StateMachine submachine) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, isConccurent, parentElement, entryAction, exitAction, doActivity, submachine);
	}
	
	public SubmachineStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  boolean isConccurent,  StateMachine submachine) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, isConccurent, submachine);
	}
