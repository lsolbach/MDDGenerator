...
public  class FinalStateImpl extends AbstractFinalState implements FinalState {
	...
	public FinalStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  int newAttr,  Element parentElement,  Action entryAction,  Action exitAction,  Action doActivity) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, newAttr, parentElement, entryAction, exitAction, doActivity);
	}
	
	public FinalStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  int newAttr) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, newAttr);
	}
