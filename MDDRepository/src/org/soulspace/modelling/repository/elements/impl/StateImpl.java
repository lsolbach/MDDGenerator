...
public  class StateImpl extends AbstractState implements State {
	...
	public StateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement,  Action entryAction,  Action exitAction,  Action doActivity) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement, entryAction, exitAction, doActivity);
	}
	
	public StateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName) {
