...
public  class SimpleStateImpl extends AbstractSimpleState implements SimpleState {
	...
	public SimpleStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Element parentElement,  Action entryAction,  Action exitAction,  Action doActivity) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, parentElement, entryAction, exitAction, doActivity);
	}
	
	public SimpleStateImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName) {
