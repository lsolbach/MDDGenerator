...
public  class StereotypeImpl extends AbstractStereotype implements Stereotype {
	...
	public StereotypeImpl( String id,  boolean isProfileElement,  boolean initialized,  String namespace,  String qualifiedName,  String name,  Element parentElement) {
		super(id, isProfileElement, initialized, namespace, qualifiedName, name, parentElement);
	}
	
	public StereotypeImpl( String id,  boolean isProfileElement,  boolean initialized,  String namespace,  String qualifiedName,  String name) {
		super(id, isProfileElement, initialized, namespace, qualifiedName, name);
	}
