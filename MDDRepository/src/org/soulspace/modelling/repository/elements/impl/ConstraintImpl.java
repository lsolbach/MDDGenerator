...
public  class ConstraintImpl extends AbstractConstraint implements Constraint {
	...
	public ConstraintImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Expression expression,  Element parentElement) {
		super(id, isProfileElement, initialized, name, namespace, qualifiedName, expression, parentElement);
	}
	
	public ConstraintImpl( String id,  boolean isProfileElement,  boolean initialized,  String name,  String namespace,  String qualifiedName,  Expression expression) {
